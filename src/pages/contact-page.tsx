  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 space-y-12">
      <div className="text-center space-y-3">
        <h1 className="text-3xl md:text-4xl font-black tracking-tight">Contacto</h1>
        <p className="text-muted-foreground text-sm max-w-xl mx-auto">
          Ponte en contacto con nosotros a través de cualquiera de estos medios. Estamos aquí para ayudarte.
        </p>
      </div>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          {floatingWhatsapp && (
            <a
              href={`https://wa.me/${floatingWhatsapp.replace(/\+/g, "")}`}
              target="_blank"
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{floatingWhatsapp}</p>
              </div>
            </a>
          )}
          ...
          {orderWhatsapp && orderWhatsapp !== floatingWhatsapp && (
            <a
              href={`https://wa.me/${orderWhatsapp.replace(/\+/g, "")}`}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 p-4 rounded-xl border bg-card hover:bg-accent/50 transition-colors"
            >
              ...
              <div>
                <p className="text-sm font-medium">WhatsApp (Pedidos)</p>
                <p className="text-sm text-muted-foreground">{orderWhatsapp}</p>
              </div>
            </a>
          )}
          ...
          {(!contactEmail && !floatingWhatsapp && !orderWhatsapp) && (
            <p className="text-sm text-muted-foreground italic">
              No hay información de contacto configurada. Ve al panel de administración para agregarla.
            </p>
          )}
        </div>
        ...
        <div className="space-y-6">
          ...
          {socialLinks.length > 0 ? (
            ...
            <p className="text-sm text-muted-foreground italic">
              No hay redes sociales configuradas. Agrégalas desde el panel de ajustes.
            </p>
          )}
        </div>
      </div>
